...
export class AddKurinHierarchy1762328016869 implements MigrationInterface {
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `CREATE TABLE "kurins" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "created_at" TIMESTAMP NOT NULL DEFAULT now(), "update_at" TIMESTAMP NOT NULL DEFAULT now(), "name" character varying(255) NOT NULL, "liaison_id" uuid, CONSTRAINT "PK_kurins_id" PRIMARY KEY ("id"))`
    )
    ...
    await queryRunner.query(
      `ALTER TABLE "kurins" ADD CONSTRAINT "FK_kurins_liaison_id" FOREIGN KEY ("liaison_id") REFERENCES "users"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`
    )
    ...
    await queryRunner.query(
      `ALTER TABLE "invites" ADD CONSTRAINT "FK_invites_created_by_id" FOREIGN KEY ("created_by_id") REFERENCES "users"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`
    )
  }
