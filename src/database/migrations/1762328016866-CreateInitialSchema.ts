...
export class CreateInitialSchema1762328016866 implements MigrationInterface {
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `CREATE TABLE "proba_templates" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "created_at" TIMESTAMP NOT NULL DEFAULT now(), "update_at" TIMESTAMP NOT NULL DEFAULT now(), "name" character varying(255) NOT NULL, "level" integer NOT NULL, "gender_variant" "public"."proba_templates_gender_variant_enum" NOT NULL DEFAULT 'NEUTRAL', "version" integer NOT NULL DEFAULT '1', "is_active" boolean NOT NULL DEFAULT true, CONSTRAINT "PK_ccb1f335dbcf058166d68363e13" PRIMARY KEY ("id"))`
    )
    await queryRunner.query(
      `CREATE TABLE "proba_section_templates" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "created_at" TIMESTAMP NOT NULL DEFAULT now(), "update_at" TIMESTAMP NOT NULL DEFAULT now(), "title" character varying(255) NOT NULL, "order" integer NOT NULL, "template_id" uuid, CONSTRAINT "PK_d42048c4d50ff81705b3a03ed3d" PRIMARY KEY ("id"))`
    )
    await queryRunner.query(
      `CREATE TABLE "proba_item_templates" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "created_at" TIMESTAMP NOT NULL DEFAULT now(), "update_at" TIMESTAMP NOT NULL DEFAULT now(), "text" text NOT NULL, "order" integer NOT NULL, "section_id" uuid, CONSTRAINT "PK_7c832adab4716758826c1860cfb" PRIMARY KEY ("id"))`
    )
    await queryRunner.query(
      `CREATE TABLE "user_proba_progress" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "is_completed" boolean NOT NULL DEFAULT false, "completed_at" TIMESTAMP, "user_id" uuid, "proba_item_id" uuid, "signed_by_id" uuid, CONSTRAINT "PK_a04a113e802c4b33c5f896c4b3a" PRIMARY KEY ("id"))`
    )
    await queryRunner.query(
      `CREATE TABLE "roles" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "created_at" TIMESTAMP NOT NULL DEFAULT now(), "update_at" TIMESTAMP NOT NULL DEFAULT now(), "name" character varying(50) NOT NULL, CONSTRAINT "UQ_648e3f5447f725579d7d4ffdfb7" UNIQUE ("name"), CONSTRAINT "PK_c1433d71a4838793a49dcad46ab" PRIMARY KEY ("id"))`
    )
    await queryRunner.query(
    ...
    await queryRunner.query(
      `CREATE TABLE "proba_notes" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "created_at" TIMESTAMP NOT NULL DEFAULT now(), "update_at" TIMESTAMP NOT NULL DEFAULT now(), "content" text NOT NULL, "progress_id" uuid, "created_by_id" uuid, CONSTRAINT "PK_e7106d02d1df578073a1fc6d294" PRIMARY KEY ("id"))`
    )
    await queryRunner.query(
      `ALTER TABLE "proba_section_templates" ADD CONSTRAINT "FK_457a0ef9ee7d8d58dd846967fe3" FOREIGN KEY ("template_id") REFERENCES "proba_templates"("id") ON DELETE CASCADE ON UPDATE NO ACTION`
    )
    await queryRunner.query(
      `ALTER TABLE "proba_item_templates" ADD CONSTRAINT "FK_3c360baa15234e1037b14a2e541" FOREIGN KEY ("section_id") REFERENCES "proba_section_templates"("id") ON DELETE CASCADE ON UPDATE NO ACTION`
    )
    await queryRunner.query(
      `ALTER TABLE "user_proba_progress" ADD CONSTRAINT "FK_2e1bdceeb50d4391501b9203037" FOREIGN KEY ("user_id") REFERENCES "users"("id") ON DELETE CASCADE ON UPDATE NO ACTION`
    )
    await queryRunner.query(
      `ALTER TABLE "user_proba_progress" ADD CONSTRAINT "FK_77feab6958d2526f775a07baa25" FOREIGN KEY ("proba_item_id") REFERENCES "proba_item_templates"("id") ON DELETE CASCADE ON UPDATE NO ACTION`
    )
    await queryRunner.query(
      `ALTER TABLE "user_proba_progress" ADD CONSTRAINT "FK_7f3fb127e0e105cdf11cc832f46" FOREIGN KEY ("signed_by_id") REFERENCES "users"("id") ON DELETE SET NULL ON UPDATE NO ACTION`
    )
    await queryRunner.query(
    ...
    await queryRunner.query(
      `ALTER TABLE "group_memberships" ADD CONSTRAINT "FK_e232a617b3bc2de2e13c0289d62" FOREIGN KEY ("user_id") REFERENCES "users"("id") ON DELETE CASCADE ON UPDATE NO ACTION`
    )
    await queryRunner.query(
      `ALTER TABLE "group_memberships" ADD CONSTRAINT "FK_cad344fe877fcee0ac7e065ed05" FOREIGN KEY ("group_id") REFERENCES "groups"("id") ON DELETE CASCADE ON UPDATE NO ACTION`
    )
    await queryRunner.query(
      `ALTER TABLE "users" ADD CONSTRAINT "FK_a2cecd1a3531c0b041e29ba46e1" FOREIGN KEY ("role_id") REFERENCES "roles"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`
    )
    await queryRunner.query(
      `ALTER TABLE "invites" ADD CONSTRAINT "FK_9ff46285fb5f05b824d68b75e4a" FOREIGN KEY ("foreman_id") REFERENCES "users"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`
    )
    await queryRunner.query(
      `ALTER TABLE "invites" ADD CONSTRAINT "FK_c050267df909b5bf9ad9b3b943b" FOREIGN KEY ("scout_id") REFERENCES "users"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`
    )
    await queryRunner.query(
      `ALTER TABLE "proba_notes" ADD CONSTRAINT "FK_3391265d1c82e5e4c44d38f13a6" FOREIGN KEY ("progress_id") REFERENCES "user_proba_progress"("id") ON DELETE CASCADE ON UPDATE NO ACTION`
    )
    await queryRunner.query(
      `ALTER TABLE "proba_notes" ADD CONSTRAINT "FK_46af8819133b9189c6d5bc748bd" FOREIGN KEY ("created_by_id") REFERENCES "users"("id") ON DELETE CASCADE ON UPDATE NO ACTION`
    )
  }
